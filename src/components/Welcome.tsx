...
function Welcome({nextStep}:propType){
    return (
        <div className='flex flex-col items-center justify-center min-h-screen text-center p-6  bg-linear-b from-green-100 to-white'>
...
className='mt-4 text-gray-700 text-lg md:text-xl max-w-lg'
 ...
 Your one-stop destination for fresh groceries, organic produce, and daily essentials deliveredright to your doorstep.
  </motion.p>
